...
const RegisterFacai = ({ handleLoginOpen, setIsModalOpen }) => {
  ...
  const translations = {
    ...
    bn: {
      ...
      password: "গোপন নম্বর",
      passwordMismatch: "গোপন নম্বর মেলেনি",
      placeholderPassword: "৬-২০ অক্ষর নাম্বার এলাউ",
      confirmPassword: "গোপন নম্বর নিশ্চিত করুন",
  ...
  return (
    <div>
      <div className="pb-14 h-screen md:h-fit  mx-auto lg:max-w-6xl bg-jili-bgBlack text-white">
            ...
            <div className="p-2">
              ...
              <div className="bg-jili-bgSecondary bg-opacity-70 p-2 rounded flex flex-col gap-2 mt-2  ">
                ...
                <div className="flex flex-col">
                  ...
                  {passwordError && (
                    <div className="text-red-500 text-sm mt-1 p-1 italic">
                      {t.passwordMismatch}
                    </div>
                  )}
                </div>
